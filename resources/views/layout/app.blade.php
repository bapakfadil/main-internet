...
<html lang="en">
  ...
  <head>
    ...
    <!-- [Favicon] icon -->
    <link rel="icon" href="{{ url('/assets/images/awinet.png') }}" type="image/x-icon">
    <!-- [Google Font] Family -->
      ...
      <div class="footer-wrapper container-fluid">
        <div class="row">
          <div class="col-sm-6 my-1">
            <p class="m-0">Berry &#9829; crafted by Team <a href="https://themeforest.net/user/codedthemes" target="_blank">Codedthemes</a></p>
          </div>
